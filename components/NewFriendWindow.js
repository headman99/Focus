...
const NewFriendWindow = ({ pressPlus, setPressPlus, friends }) => {
    ...
    const handleFilter = async () => {
        let arrayPromises = await getPossibleFriendsBySimilarUsername(database, filter, friends);
    ...
    const OnPressAddFriend = async () => {
        //Prima di fare questo mi serve una variabile context per le informazioni del documento dell'utente in corso
        //const documento = doc(database, `users/${idUtente}`);
